...
<form className="max-w-md mx-auto">
  <div className="relative z-0 w-full mb-5 group">
      <input type="email" value={userName} onChange={(e)=>setUserName(e.target.value)} name="floating_email" id="floating_email" className="block py-2.5 px-0 w-full text-sm text-gray-950 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-gray-950 dark:border-gray-600 dark:focus:border-gray-600 focus:outline-none focus:ring-0 focus:border-gray-600 peer" placeholder=" " required />
